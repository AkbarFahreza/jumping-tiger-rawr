...
const CommsTypeDropDown = ({ options, selectedOption, onSelect }) => {
  ...
  return (
    <div className="mobile-container relative inline-block text-left caret-hidden ">
      <div>
        <span className="caret-hidden rounded-md shadow-sm">
          <button
            type="button"
            onClick={() => setIsOpen(!isOpen)}
            className="caret-hidden inline-flex justify-between w-[240px] py-2 mobile-heading-b font-medium text-white rounded-md"
          >
...
export default CommsTypeDropDown;
