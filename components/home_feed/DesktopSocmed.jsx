  ...
  return (
    <div className="flex-row gap-3 mt-4 md:flex justify-center hidden mx-auto ">
        ...
        <Link href="https://twitter.com/Revernry" className="">
          ...
          >
            <path
              ...
              className="fill-white hover:fill-purple transition-all duration-200"
            />
          </svg>
        </Link>
      </motion.div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.5, delay: 0.8 }}
      >
        <Link href="https://trello.com/b/Uw92MTM7/dekreza-commissions-info">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
